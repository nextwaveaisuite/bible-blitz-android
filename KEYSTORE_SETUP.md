...
### 2. Updated App Build Configuration (`bible-blitz-android/app/build.gradle`)
...
Then run:
```bash
cd bible-blitz-android
./gradlew clean bundleRelease
```

The signed AAB will be at:
```
bible-blitz-android/app/build/outputs/bundle/release/app-release.aab
```
